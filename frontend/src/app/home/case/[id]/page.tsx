                        ...
                        <div className="flex flex-col gap-2 flex-wrap">
                          {isLoading ? (
                            ...
                            <div className="flex justify-between">
                              ...
                              <Link
                                href={caseData.summary.document}
                                target="_blank"
                ...
                {isLoading ? (
                  ...
                  <div className="flex flex-col w-full h-full justify-between">
                    <div className="w-full p-4 flex flex-col justify-center">
                      <form
                        className="flex flex-col items-center justify-center gap-4 w-full px-6 py-4 bg-white/90 backdrop-filter backdrop-blur-sm shadow-md rounded-lg z-10 max-w-3xl mx-auto"
                        onSubmit={handleGisSubmit}
                      >
